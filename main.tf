...
# #deploy checkpoint security manager appliance
...
# # }
# #
# # resource "azurerm_public_ip" "lab7-public-checkpoint-ip" {
# #   name                = "lab7-public-checkpoint-ip"
# #   location            = azurerm_resource_group.az-spoke2-rg.location
# #   resource_group_name = azurerm_resource_group.az-spoke2-rg.name
# #   allocation_method   = "Dynamic"
# # }
# #
# # resource "azurerm_network_interface" "checkpoint-security-management-nic" {
# #   name                = "checkpoint-security-management-nic"
# #   location            = azurerm_resource_group.az-spoke2-rg.location
# #   resource_group_name = azurerm_resource_group.az-spoke2-rg.name
# #   ip_configuration {
# #     name                          = "azure-us-west-spoke2-test1-nic"
...
# #     public_ip_address_id = azurerm_public_ip.lab7-public-checkpoint-ip.id
# #   }
# #   depends_on = [azurerm_resource_group.az-spoke2-rg, data.azurerm_subnet.azure-us-west-spoke2]
# # }
# #
# # resource "azurerm_virtual_machine" "checkpoint-security-manager" {
# #   name                  = "checkpoint-security-manager"
# #   location              = azurerm_resource_group.az-spoke2-rg.location
# #   resource_group_name   = azurerm_resource_group.az-spoke2-rg.name
# #   network_interface_ids = [azurerm_network_interface.checkpoint-security-management-nic.id]
...
# #   }
# #
# #   # plan is required to deploy markerplace VM
# #   plan {
# #     publisher = "checkpoint"
...
# #
# #   storage_os_disk {
# #     name          = "azure-us-west-checkpoint-management-disk"
# #     create_option = "FromImage"
# #     caching       = "ReadWrite"
# #   }
# #
# #
# #   os_profile {
# #     computer_name  = "checkpoint-security-manager"
# #     admin_username = "checkpoint" # login username can only be admin
# #     admin_password = "Password123!"
# #     custom_data = file("./cp-init.sh") # bootstrap script
# #   }
# #
# #   os_profile_linux_config {
# #     disable_password_authentication = false
...
# # }
# #
# # data "azurerm_public_ip" "lab7-public-checkpoint-ip" {
# #   name                = azurerm_public_ip.lab7-public-checkpoint-ip.name
# #   resource_group_name = azurerm_resource_group.az-spoke2-rg.name
# #   depends_on          = [azurerm_virtual_machine.checkpoint-security-manager]
# # }
#
# # deploy windows vm for security console
# # resource "azurerm_public_ip" "checkpoint-smartconsole-IP" {
# #   name                = "checkpoint-smartconsole-IP"
# #   location            = azurerm_resource_group.az-spoke2-rg.location
# #   resource_group_name = azurerm_resource_group.az-spoke2-rg.name
# #   allocation_method   = "Dynamic"
# # }
# #
# # resource "azurerm_network_interface" "checkpoint-smartconsole-nic" {
# #   name                = "checkpoint-smartconsole-nic"
# #   location            = azurerm_resource_group.az-spoke2-rg.location
# #   resource_group_name = azurerm_resource_group.az-spoke2-rg.name
# #   ip_configuration {
# #     name                          = "checkpoint-smartconsole-nic"
# #     subnet_id                     = data.azurerm_subnet.azure-us-west-spoke2.id
# #     private_ip_address_allocation = "Dynamic"
# #     public_ip_address_id          = azurerm_public_ip.checkpoint-smartconsole-IP.id
# #   }
# #   depends_on = [azurerm_resource_group.az-spoke2-rg, data.azurerm_subnet.azure-us-west-spoke2]
# # }
# #
# # resource "azurerm_windows_virtual_machine" "checkpoint-smartconsole-VM" {
# #   name                  = "smartconsole-VM"
# #   location              = azurerm_resource_group.az-spoke2-rg.location
# #   resource_group_name   = azurerm_resource_group.az-spoke2-rg.name
# #   network_interface_ids = [azurerm_network_interface.checkpoint-smartconsole-nic.id]
# #   size                  = "Standard_D3_v2"
# #   admin_username        = "acepro"
# #   admin_password        = "Password123!"
# #
...
# # }
# #
# # data "azurerm_public_ip" "checkpoint-smartconsole-IP" {
# #   name                = azurerm_public_ip.checkpoint-smartconsole-IP.name
# #   resource_group_name = azurerm_resource_group.az-spoke2-rg.name
# #   depends_on          = [azurerm_windows_virtual_machine.checkpoint-smartconsole-VM]
# # }
#
# ################################### Lab-8 requirment ###################################
# // create cisco csr instance
# /*
# 1) create vpc from aws module
# 2) create security group for csr test environment
# 3) create ssh-key with pre-defined public key
# 4) create csr instance
# */
